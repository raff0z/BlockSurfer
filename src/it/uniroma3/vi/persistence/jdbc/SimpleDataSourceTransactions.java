...
public class SimpleDataSourceTransactions {

    private static Logger logger = Logger
	    .getLogger("it.uniroma3.persistence.vi.jdbc.SimpleDataSourceTransactions");
    private ComboPooledDataSource cpds;
    private static SimpleDataSourceTransactions instance;

    public SimpleDataSourceTransactions() {
    ...
    public static SimpleDataSourceTransactions getInstance() {
	if (instance == null)
	    instance = new SimpleDataSourceTransactions();
	return instance;
    }
